    ...
    return (
        <div>
            ...
            <div className='grid justify-center lg:ml-10 my-8'>
                ...
                <p className='text-md bg-white rounded-full w-2/3 p-5'><span className='font-bold'>Ans:- </span>JWT, or JSON Web Token , is an open standard used to share security information between two parties — a client and a server. Each JWT contains encoded JSON objects, including a set of claims. JWTs are signed using a cryptographic algorithm to ensure that the claims cannot be altered after the token is issued.</p>
            </div>
            <div className='grid justify-center lg:ml-10 my-8'>
                <h1 className='bg-white rounded-full text-xl p-4 w-2/4 font-bold my-3'>
                    <span className='text-blue-500 font-bold'>3. </span> What is the difference between javascript and NodeJS?</h1>
                <p className='text-md bg-white rounded-full w-2/3 p-5'><span className='font-bold'>Ans:- </span>Javascript is a programming language that is used for writing scripts on the website.
